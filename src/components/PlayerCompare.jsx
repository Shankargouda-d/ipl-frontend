    ...
    <div ref={ref} style={{ position: "relative", flex: 1, minWidth: 220 }}>
      ...
      <input
        ...
        style={{
          ...
          borderRadius: 8,
          background: "#111",
          border: `1px solid ${open ? color : "#333"}`,
          color: "#fff",
          fontSize: 14,
          outline: "none",
    ...
    <div style={{ marginBottom: 18 }}>
      ...
      >
        <div
          style={{
            width: `${pct1}%`,
            background: `linear-gradient(90deg, ${c1}cc, ${c1})`,
        ...
        <div
          style={{
            flex: 1,
            background: `linear-gradient(90deg, ${c2}, ${c2}cc)`,
...
export default function PlayerCompare() {
  ...
  const showWickets =
    p1 &&
    p2 &&
    (Number(p1.total_wickets) > 0 || Number(p2.total_wickets) > 0);
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8,
              border: "none",
              cursor: sel1 && sel2 ? "pointer" : "not-allowed",
              background: sel1 && sel2 ? "#d85a30" : "#2a2a2a",
              color: sel1 && sel2 ? "#fff" : "#555",
              fontWeight: 700,
              fontSize: 14,
              alignSelf: sel1 ? "flex-end" : "center",
              marginTop: sel1 ? 4 : 0,
      ...
      {compareData?.length === 2 && (
        <>
          ...
          <div
            style={{
              marginTop: 28,
              background: `linear-gradient(135deg, ${c1}22 0%, #0d0d0d 50%, ${c2}22 100%)`,
              border: "1px solid #1f1f1f",
              borderRadius: 16,
              padding: "28px 24px",
            }}
          >
            {/* Header with player names (avatars removed) */}
            <div
              style={{
                display: "flex",
                justifyContent: "space-between",
            ...
            >
              ...
              {[
                ...
                ...(showWickets
                  ? [["Wickets", p1.total_wickets, p2.total_wickets]]
                  : []),
              ].map(([label, v1, v2]) => (
                <StatBar
                  key={label}
            ...
            >
              {[
                {
                  label: "Runs Comparison",
                  v1: Number(p1.total_runs),
                  v2: Number(p2.total_runs),
                },
                {
                  label: "Fours (4s) Comparison",
                  v1: Number(p1.total_fours),
                  v2: Number(p2.total_fours),
                },
                {
                  label: "Sixes (6s) Comparison",
                  v1: Number(p1.total_sixes),
                  v2: Number(p2.total_sixes),
                },
                ...(showWickets
                  ? [
                      {
                        label: "Wickets Comparison",
                        v1: Number(p1.total_wickets),
                        v2: Number(p2.total_wickets),
                      },
                    ]
                  : []),
              ].map(({ label, v1, v2 }) => (
